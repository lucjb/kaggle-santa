...
public class SliceBruteTest {
	...
	public static Collection<Object[]> parameters() {
		return Arrays.<Object[]> asList(oa(of(1, 0, 998, 993), of(5, 1, 991, 995), of(0, 3, 999, 995)),
				...
				oa(of(0, 0, 999, 997), of(2, 1, 998, 996), of(0, 0, 999, 1000)), 
				oa(of(1, 1, 999, 999), of(0, 1, 998, 998)),
				...
				oa(of(0,0,10,10), of(10,0,5,5)),
				oa(of(0,1,998,996), of(2,1,996,998),of(1,1,997,997)),
				oa(of(0,0,10,10), of(10,5,10,10)),
				oa(of(10,5,10,10), of(0,0,10,10)),
				oa(of(0,100,10,10), of(10,5,10,10)),
				oa(of(24, 353, 23, 54), of(24, 410, 2, 7), of(21, 411, 3, 8), of(26, 407, 3, 4))
